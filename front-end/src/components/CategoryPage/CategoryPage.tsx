...
import api, { ApiResponse, getIdentity, getId } from '../../api/api';
...
export default class CategoryPage extends React.Component<CategoryPageProperties> {
               ...
               { this.printFilters() }
                ...
                <Col xs="12" md="9">
                    <Row>
                    {
                            ...
                            {
                                return (!this.checkFlowerExpiredDate(flower.expiredAt))?
    ...
    private getCategoryData() {
        api('/api/category/' + this.props.match.params.cId, 'get', {})
            .then((res: ApiResponse) => {
                if (res.status === 'login' || getId()===null) {
                    
                    return this.setLogginState(false);
                }
    
                if (res.status === 'error') {
                    return this.setMessage('Došlo je do greške. Molimo Vas osvežite stranicu.');
                }
    ...
    checkGhostFlowers()
    {
        ...
        return counterExpired===size;
    }
    generateFlowers()
    {
       if(this.state.flowers.length===0)
       {
           return (<p>Nema cveca</p>);
       }  
       
       if(this.checkGhostFlowers()){
           return (<p>Nema cveca, duhovi</p>);
       }
